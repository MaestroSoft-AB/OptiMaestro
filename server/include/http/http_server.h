...
typedef enum
{
  ...
  /*Null pointers negative fd's*/ // what?
...
int http_server_init(HTTP_Server* _Server, http_server_on_connection _on_connection,
                     void* _context);
int http_server_init_ptr(http_server_on_connection _on_connection, void* _context,
                         HTTP_Server** _Server_Ptr);
